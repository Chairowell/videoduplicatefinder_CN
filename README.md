...
> [!TIP]
> 鉴于 VDF 原仓库作者已经实现了[多语言功能](https://github.com/0x90d/videoduplicatefinder/commit/3fd413d66dbb3cdf52e03234ac71439cc0a1edcf)，简体汉化已经被集成在预构建版内。此仓库将转为存档，对此此仓库的汉化问题不再做处理，感谢你的理解与支持。
